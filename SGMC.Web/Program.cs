...
static void SeedData(HealtSyncContext context)
{
    ...
    var userDoctor1 = new User { UserId = 1, Email = "doctor1@sgmc.com", PasswordHash = seedPasswordHash, RoleId = roleDoctor.RoleId, CreatedAt = DateTime.Now, IsActive = true };
    var userDoctor2 = new User { UserId = 2, Email = "doctor2@sgmc.com", PasswordHash = seedPasswordHash, RoleId = roleDoctor.RoleId, CreatedAt = DateTime.Now, IsActive = true };
    var userPaciente1 = new User { UserId = 3, Email = "paciente1@sgmc.com", PasswordHash = seedPasswordHash, RoleId = rolePaciente.RoleId, CreatedAt = DateTime.Now, IsActive = true };
    var userPaciente2 = new User { UserId = 4, Email = "paciente2@sgmc.com", PasswordHash = seedPasswordHash, RoleId = rolePaciente.RoleId, CreatedAt = DateTime.Now, IsActive = true };
    var userAdmin = new User { UserId = 5, Email = "admin@sgmc.com", PasswordHash = seedPasswordHash, RoleId = roleAdmin.RoleId, CreatedAt = DateTime.Now, IsActive = true };

    context.Users.AddRange(userDoctor1, userDoctor2, userPaciente1, userPaciente2, userAdmin);
    context.SaveChanges();

    // Personas
    var person1 = new Person { PersonId = 1, FirstName = "Juan", LastName = "Perez", DateOfBirth = new DateOnly(1980, 5, 10), IdentificationNumber = "001-1234567-1", Gender = "Masculino", UserId = userDoctor1.UserId };
    var person2 = new Person { PersonId = 2, FirstName = "Ana", LastName = "Gomez", DateOfBirth = new DateOnly(1985, 3, 22), IdentificationNumber = "001-1234567-2", Gender = "Femenino", UserId = userDoctor2.UserId };
    var person3 = new Person { PersonId = 3, FirstName = "Carlos", LastName = "Martinez", DateOfBirth = new DateOnly(1990, 7, 15), IdentificationNumber = "001-1234567-3", Gender = "Masculino", UserId = userPaciente1.UserId };
    var person4 = new Person { PersonId = 4, FirstName = "Maria", LastName = "Lopez", DateOfBirth = new DateOnly(1995, 1, 30), IdentificationNumber = "001-1234567-4", Gender = "Femenino", UserId = userPaciente2.UserId };
    ...
    var doctor1 = new Doctor
    {
        ...
        Bio = "Especialista en cardiologia con 10 anos de experiencia.",
    ...
    var doctor2 = new Doctor
    {
        ...
        YearsOfExperience = 6,
        Education = "Pontificia Universidad Catolica Madre y Maestra",
        Bio = "Pediatra con enfoque en atencion infantil integral.",
