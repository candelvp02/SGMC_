    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<OperationResult<AppointmentDto>>> GetById(int id)
        {
            ...
            try
            {
                ...
                // Si quien pregunta se autenticó como Paciente o Médico, solo puede ver sus propias citas (evita que adivinando el ID vea citas de otra persona).
            ...
            [FromQuery] DateTime? to)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, OperationResult.Fallo("Error inesperado al obtener tu agenda."));
            }
        }
    }
}